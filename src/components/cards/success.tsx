...
export default function Success() {
  return (
    <div className="w-80 h-96 bg-white flex flex-col justify-around items-start text-start shadow-xl text-center rounded-sm p-4 mb-12">
      ...
      <p>
        We were struggling to maintain a cohesive brand voice. Words on Us
        turned things around with a thoughtful content and strategy execution.
      </p>
      <div className="flex justify-between items-center  w-5/6 ">
        <Image alt=" strategy" src="/images/star.svg" height={50} width={50} />
